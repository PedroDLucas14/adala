<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="nombre" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required
                autofocus autocomplete="name" />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
        <div class="mt-4">
            <x-input-label for="apellido_1" :value="__('Primer apellido')" />
            <x-text-input id="apellido_1" class="block mt-1 w-full" type="text" name="apellido_1" :value="old('apellido_1')"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="fecha_nac" class="block mt-1 w-full" type="date" name="fecha_nac" :value="old('fecha_nac')"
                required autofocus autocomplete="fecha_nac" />
            <x-input-error :messages="$errors->get('fecha_nac')" class="mt-2" />
        </div>
        <div class="mt-4">
            <x-input-label for="telefono_contacto" :value="__('Teléfono')" />
            <x-text-input id="telefono_contacto" class="block mt-1 w-full" type="text" name="telefono_contacto"
                :value="old('telefono_contacto')" required autofocus autocomplete="telefono_contacto" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="provincia" class="block mt-1 w-full" type="text" name="provincia" :value="old('provincia')"
                required autofocus autocomplete="provincia" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="codigo_postal" class="block mt-1 w-full" type="text" name="codigo_postal"
                :value="old('codigo_postal')" required autofocus autocomplete="codigo_postal" />
